...
class Settings:
	def __init__(self):
		...
		#Zombie settings
		self.zombie_ACC1, self.zombie_ACC2, self.zombie_ACC3 = 0.003, 0.06, 0.02
		self.zombie_ACC4, self.zombie_ACC5, self.zombie_ACC6 = 0.009, 0.003, 0.09

		self.zombie_colors = {
			'zombie1_color1': 'darkgreen', 'zombie1_color2': 'black',
			'zombie2_color1': 'orangered', 'zombie2_color2': 'black',
			'zombie3_color1': 'red1', 'zombie3_color2': 'black',
			'zombie4_color1': 'springgreen', 'zombie4_color2': 'white',
			'zombie5_color1': 'indigo', 'zombie5_color2': 'gold',
			'zombie6_color1': 'red2', 'zombie6_color2': 'black',
		}
